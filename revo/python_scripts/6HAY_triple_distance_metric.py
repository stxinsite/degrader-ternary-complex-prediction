...
inputs_dir = osp.realpath('./6HAY_inputs')
# the outputs path                                                                                   
...
# inputs filenames                                                                                   
native_amber_parm7_filename = 'bound_protac1_chainAB.complex.wat_parm7'
native_amber_rst7_filename = 'bound_protac1_relax-7.rst7'
native_pdb_filename = 'bound_protac1_chainAB.complex.pdb'

starting_amber_parm7_filename = 'unbound_smarka2_vhl_protac1_chainAB.complex.wat.parm7'
starting_amber_rst7_filename = 'unbound_relax-7.rst7'

# outputs                                                                                            
hdf5_filename = 'protac1_binding_results_REVO.wepy.h5'
dashboard_filename = 'protac1_binding_REVO.dash.txt'
...
def main(n_runs, n_cycles, steps, n_walkers, n_workers=1, seed=None):
    ...
    start_pro_b_idx = start_mdj_top.select('resid 0 to 132')
    start_pro_d_idx = start_mdj_top.select('resid 133  to 284')
    start_linker_idx = start_mdj_top.select('name "C33" or name "C34" or name "C35" or name "C36" or name "C37" or name "C38" or name "C39" or name "C40" or name "C41" or name "C42" or name "C43" or name "C44"  or name "C45" or name "C46" or name "N5" or name "N6" or name "N7" or name "N8" or name "N9" or name "O8"')
    ...
    native_pro_b_idx = native_top.select('resid 0 to 132')
    native_pro_d_idx = native_top.select('resid 133 to 281')
    native_warhead_idx = start_mdj_top.select('name "C33" or name "C34" or name "C35" or name "C36" or name "C37" or name "C38" or name "C39" or name "C40" or name "C41" or name "C42" or name "C43" or name "C44"  or name "C45" or name "C46" or name "N5" or name "N6" or name "N7" or name "N8" or name "N9" or name "O8"')                                  
    ...
    target_resid_list = np.arange(0, 114)
    protac_resid_list = [266]
    print(native_top.select('resid 266'))
    ...
    print(target_binding_protac_idx)
    print(target_binding_protac_resid)
